<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceReport.aspx.cs" Inherits="QwertyPOS.WebForm3" %>
...
<head runat="server">
    ...
    <title>Finance Report | Qwerty Kicks</title>
...
<body>
    ...
    <div class="main">
        <div class="col-md-5">
            <p>
                Select the dates for which you would like to run a financial report below.
            </p>
        </div>
    </div>
    <div class="main">
